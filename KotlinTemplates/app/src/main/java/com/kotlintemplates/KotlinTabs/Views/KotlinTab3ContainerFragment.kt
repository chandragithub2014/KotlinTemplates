 ...
 *
 */
class KotlinTab3ContainerFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        root3View =  inflater.inflate(R.layout.fragment_kotlin_tab3_container, container, false)
        activity!!.supportFragmentManager.beginTransaction().replace(R.id.root_container3, GridListFragment()).commit()
        return root3View
    }
