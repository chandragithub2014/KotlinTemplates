 ...
 *
 */
class KotlinTab1ContainerFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        root1View  =  inflater.inflate(R.layout.fragment_kotlin_tab1_container, container, false)
        activity!!.supportFragmentManager.beginTransaction().replace(R.id.root_container1, SimpleLazyListFragment()).commit()
        return root1View
    }
