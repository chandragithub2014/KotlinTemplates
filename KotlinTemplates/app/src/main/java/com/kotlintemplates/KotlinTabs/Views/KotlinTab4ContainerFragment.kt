 ...
 *
 */
class KotlinTab4ContainerFragment : Fragment() {
    // TODO: Rename and change types of parameters
    private var param1: String? = null
    private var param2: String? = null
    private var root4View: View? = null
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        root4View = inflater.inflate(R.layout.fragment_kotlin_tab4_container, container, false)
        activity!!.supportFragmentManager.beginTransaction().replace(R.id.root_container4, DiffUtilFragment()).commit()
        return  root4View
    }
