 ...
 *
 */
class RoomDBDiUtilListFragment : Fragment(),ClickListener {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        myView =  inflater.inflate(R.layout.fragment_room_db_difflist, container, false)
        ...
        addList!!.setOnClickListener({
            //populateData()
            launchAddNewEmployee()
        });
        return myView
    }

    private fun launchAddNewEmployee(){
        activity!!.supportFragmentManager.beginTransaction().replace(mContainerID, AddNewEmployeeFragment()).addToBackStack("add").commit()
    }
