...
class SimpleLazyListAdapter(val context: Context, val clickListener: ClickListener) : RecyclerView.Adapter<SimpleLazyListAdapter.SimpleLazyViewHolder>(){
    ...
    override fun onCreateViewHolder(p0: ViewGroup, p1: Int): SimpleLazyViewHolder {
        val view = LayoutInflater.from(context).inflate(R.layout.simple_lazy_list_item,p0,false)
